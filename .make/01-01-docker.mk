...
DOCKER_SERVICE_REDIS_MASTER:=redis-master
DOCKER_SERVICE_REDIS_SLAVE:=redis-slave
...
ifeq ($(EXECUTE_IN_CONTAINER),true)
	...
	EXECUTE_IN_APPLICATION_MASTER:=$(DOCKER_COMPOSE) exec -T $(DOCKER_SERVICE_REDIS_MASTER)
	EXECUTE_IN_APPLICATION_SLAVE:=$(DOCKER_COMPOSE) exec -T $(DOCKER_SERVICE_REDIS_SLAVE)
endif
